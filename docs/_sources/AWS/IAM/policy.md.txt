...
### リソースベースポリシー
基本的にはアイデンティティベースポリシーで許可をすることが多い。
一方で、クロスアカウントを実装する場合、アイデンティティベースとリソースベース両方で許可をする必要がある。


### アイデンティティベースポリシー
IAMで指定するポリシーであり、本ドキュメントではアイデンティティベースポリシーについて整理する。
