...
ウォーターフォールの上位互換ではない。
必要機能や作るべきものが決まっているのであればウォーターフォールを採用する。
...
この考え方の背景には、ソフトウェア開発において本当に重要なものは何か、という問いがある。
それは「予定通りに作ること」ではなく、ソフトウェアが顧客にとって重要な課題を解決し続けること、言い換えれば、価値のあるプロダクトであり続けることである。

しかし現実の世界では、市場や技術、顧客の状況は常に変化する。
そのため、一度作ったものをそのまま提供し続けるだけでは、価値はすぐに陳腐化してしまう。
Agileが「継続的な開発」と「サービスの向上」を重視するのは、この前提に立っているからである。

このような考え方を踏まえたとき、Agileの目的は次のように整理できる。
```
...
Agileが生まれた背景には、従来のソフトウェア開発が抱えてきた構造的な課題がある。
1. プロジェクト開始時に全ての要求を集めることはできない
2. 集めたところで要求はどれも必ずと言っていいほどかわる
3. やるべきことはいつだって与えられた時間と資金よりも多い

事前に全ての要望を洗い出し計画通りに開発を進めるという開発は苦渋の思いをしてきた。
Agileは、こうした課題を「例外」ではなく「前提」として受け入れる。
その上で、次のようなアプローチを取る。
```
顧客と共に開発を進め、  
...
ここで重要なのは、「計画しない」のではなく、経験と結果に基づいて計画を見直し続ける点にある。
まとめると、Agileは次の目的のために、短いタイムボックスの中で、少しずつ、繰り返し開発を行う。
```
...
![](../img/ITBasic/sprint_planning.png)
...
![](../img/ITBasic/product-backlog-refinement.jp.png)
...
![](../img/ITBasic/inception_deck.png)
...
![](../img/ITBasic/agile_barndown.png)
...
![](../img/ITBasic/release_planning.png)
...
![](../img/ITBasic/agile_incremental.png)
